...
### License
Unless otherwise noted, the source code of this project is covered under Crown Copyright, Government of Canada, and is distributed under the [MIT Licence](https://github.com/NRCan/GSC-Field-Application/blob/master/LICENSE.txt)
